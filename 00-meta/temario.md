...
## **3. Transistor unipolar (FET, MOSFET)**
...
4.2. Amplificador con BJT.  
  ...
  - 4.2.5. Efecto de las resistencias Rs y RL.  
...
## 📊 Mapeo Temario → Módulos del Repositorio

| Tema | Módulo | Prefijo | Carpeta |
|------|--------|---------|---------|
| 1. Circuitos con diodos | Módulo 01 | `DIO` | `01-Circuitos-Diodos/` |
| 2. Transistor BJT | Módulo 02 | `BJT` | `02-Transistor-BJT/` |
| 3. Transistor FET/MOSFET | Módulo 03 | `FET` | `03-Transistor-FET/` |
| 4. Amplificadores | Módulo 04 | `AMP` | `04-Amplificadores/` |
| 5. Proyecto Final | Módulo 05 | `PRO` | `05-Proyecto-Final/` |
