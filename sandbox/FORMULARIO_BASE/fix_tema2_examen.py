...
exam_content = r"""# Formulario de Examen: Tema 2 (Transistores BJT)
...
### 3.4 Análisis Rápido sin $\beta$ (Aproximación Práctica)
...
### 3.5 Diseño Óptimo (Excursión Simétrica Máxima)
...
print("Formulario-tema_2-examen.md was completely rewritten with raw strings.")
