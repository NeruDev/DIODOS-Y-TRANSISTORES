...
* **Modelo Real ($V_D = 0.7\text{ V}$):**
  $$
  V_{rms} \approx \frac{V_m - 2V_D}{\sqrt{2}}
...
> [!NOTE]
> *Más exactamente $\text{PIV} = V_m - V_D$, pero en la práctica se diseña con $V_m$ para conservar el margen de seguridad.*
